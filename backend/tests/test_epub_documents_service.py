...
class TestCreateOrUpdate:
    ...
    def test_create_with_metadata_json(self, service):
        ...
        _epub_id = service.create_or_update(
            filename="test_metadata.epub", chapters=5, metadata=metadata
        )
    ...
    def test_create_or_update_idempotent(self, service):
        ...
        id1 = service.create_or_update(
            filename="idempotent.epub", chapters=3, title="Same Title"
        )
    ...
    def test_create_with_minimal_fields(self, service):
        ...
        epub_id = service.create_or_update(filename="minimal.epub", chapters=1)
    ...
    def test_create_with_zero_chapters(self, service):
        ...
        _epub_id = service.create_or_update(
            filename="zero_chapters.epub", chapters=0, title="Empty Book"
        )
    ...
    def test_update_last_accessed_on_update(self, service):
        ...
        # Create document
        _epub_id = service.create_or_update(filename="timestamp_test.epub", chapters=1)
        ...
        # Update document
        service.create_or_update(filename="timestamp_test.epub", chapters=2)
...
class TestReadOperations:
    ...
    def test_get_by_filename_exists(self, service):
        ...
        service.create_or_update(filename="find_me.epub", chapters=5, title="Findable")
    ...
    def test_get_by_id_exists(self, service):
        ...
        epub_id = service.create_or_update(
            filename="id_test.epub", chapters=3, title="ID Test"
        )
...
class TestUpdateLastAccessed:
    ...
    def test_update_last_accessed(self, service):
        ...
        epub_id = service.create_or_update(filename="access_test.epub", chapters=1)
...
class TestDeleteOperations:
    ...
    def test_delete_by_filename_exists(self, service):
        ...
        service.create_or_update(filename="delete_me.epub", chapters=1)
...
class TestFilesystemSync:
    ...
    def test_sync_update_existing_files(
        self, service, temp_epub_dir, mock_epub_service
    ):
        """Test syncing updates metadata for existing files"""
        # Add document with old metadata
        service.create_or_update(filename="update.epub", chapters=1, title="Old Title")
    ...
    def test_sync_handles_errors_gracefully(
        self, service, temp_epub_dir, mock_epub_service
    ):
...
class TestEdgeCases:
    ...
    def test_special_characters_in_filename(self, service):
        ...
        _epub_id = service.create_or_update(
            filename=special_filename, chapters=1, title="Special Chars"
        )
    ...
    def test_large_metadata_json(self, service):
        ...
        _epub_id = service.create_or_update(
            filename="large_metadata.epub", chapters=1, metadata=large_metadata
        )
    ...
    def test_negative_values(self, service):
        ...
        _epub_id = service.create_or_update(
            filename="negative.epub", chapters=-1, file_size=-100
        )
