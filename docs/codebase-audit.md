...
**C-1. Fresh database is broken: schema drift after migration system deletion** — `backend/app/services/reading_progress_service.py:46-53` vs `:162, 202, 350`
